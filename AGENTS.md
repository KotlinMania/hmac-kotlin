...
This file is the quick-reference operating contract for hmac-kotlin. The longer
...
hmac-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`hmac`](https://crates.io/crates/hmac). Upstream Rust is the behavioral oracle while the
