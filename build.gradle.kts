...
fun installProjectAndroidSdk(execOperations: ExecOperations) {
    if (isProjectAndroidSdkInstalled()) {
        ...
        println("setup-android-sdk: required SDK packages already installed at $projectAndroidSdkDir")
        return
    }
...
kotlin {
    ...
    swiftExport {
        moduleName = "Hmac"
        flattenPackage = "io.github.kotlinmania.hmac"
    }

    android {
        namespace = "io.github.kotlinmania.hmac"
        compileSdk = 34
        minSdk = 24
    ...
    sourceSets {
        ...
        val commonTest by getting {
            dependencies {
                ...
                implementation("io.github.kotlinmania:md5-kotlin:0.1.0")
                implementation("io.github.kotlinmania:sha1-kotlin:0.1.0")
                implementation("io.github.kotlinmania:sha2-kotlin:0.1.0")
                implementation("io.github.kotlinmania:streebog-kotlin:0.1.0")
            }
        }
...
mavenPublishing {
    ...
    coordinates(group.toString(), "hmac-kotlin", version.toString())

    pom {
        name.set("hmac-kotlin")
        description.set("Kotlin Multiplatform port of RustCrypto/MACs - Generic implementation of Hash-based Message Authentication Code (HMAC)")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/hmac-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/hmac-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/hmac-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/hmac-kotlin.git")
        }
    }
}
...
dependencies {
    ...
    codeqlSourceClasspath("io.github.kotlinmania:digest-kotlin-jvm:0.1.0")
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.hmac.codeql
